...
// ─── PLATFORM CONFIG ─────────────────────────────────────────
const PLATFORMS = [
  { id: 'google', name: 'Google Search', icon: '🔍', color: '#4285F4', bgColor: 'rgba(66,133,244,0.08)', searchUrl: (q) => `https://www.google.com/search?q=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.google.com/search?q=${encodeURIComponent('"' + q + '"')}` },
  { id: 'linkedin', name: 'LinkedIn', icon: '💼', color: '#0A66C2', bgColor: 'rgba(10,102,194,0.08)', searchUrl: (q) => `https://www.linkedin.com/search/results/people/?keywords=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.linkedin.com/search/results/people/?keywords=${encodeURIComponent(q)}` },
  { id: 'instagram', name: 'Instagram', icon: '📸', color: '#E1306C', bgColor: 'rgba(225,48,108,0.08)', searchUrl: (q) => `https://www.instagram.com/explore/search/keyword/?q=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.instagram.com/explore/search/keyword/?q=${encodeURIComponent(q)}` },
  { id: 'facebook', name: 'Facebook', icon: '📘', color: '#1877F2', bgColor: 'rgba(24,119,242,0.08)', searchUrl: (q) => `https://www.facebook.com/search/top?q=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.facebook.com/search/people/?q=${encodeURIComponent(q)}` },
  { id: 'twitter', name: 'Twitter / X', icon: '🐦', color: '#1DA1F2', bgColor: 'rgba(29,161,242,0.08)', searchUrl: (q) => `https://twitter.com/search?q=${encodeURIComponent(q)}&src=typed_query&f=people`, profileUrl: (q) => `https://x.com/search?q=${encodeURIComponent(q)}&f=user` },
  { id: 'tiktok', name: 'TikTok', icon: '🎵', color: '#FF0050', bgColor: 'rgba(255,0,80,0.08)', searchUrl: (q) => `https://www.tiktok.com/search?q=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.tiktok.com/search/user?q=${encodeURIComponent(q)}` },
  { id: 'youtube', name: 'YouTube', icon: '▶️', color: '#FF0000', bgColor: 'rgba(255,0,0,0.08)', searchUrl: (q) => `https://www.youtube.com/results?search_query=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.youtube.com/results?search_query=${encodeURIComponent('"' + q + '"')}` },
  { id: 'github', name: 'GitHub', icon: '⚙️', color: '#6E40C9', bgColor: 'rgba(110,64,201,0.08)', searchUrl: (q) => `https://github.com/search?q=${encodeURIComponent(q)}&type=users`, profileUrl: (q) => `https://github.com/search?q=${encodeURIComponent(q)}&type=users` },
  { id: 'yandex', name: 'Yandex Images', icon: '🖼️', color: '#FF0000', bgColor: 'rgba(255,0,0,0.08)', searchUrl: (q) => `https://yandex.com/images/search?text=${encodeURIComponent(q)}`, profileUrl: (q) => `https://yandex.com/images/search?text=${encodeURIComponent(q + ' profile')}` },
  { id: 'google_img', name: 'Google Images', icon: '🌅', color: '#34A853', bgColor: 'rgba(52,168,83,0.08)', searchUrl: (q) => `https://www.google.com/search?tbm=isch&q=${encodeURIComponent(q)}`, profileUrl: (q) => `https://www.google.com/search?tbm=isch&q=${encodeURIComponent(q + ' face profile')}` },
  { id: 'bing', name: 'Bing People', icon: '🔷', color: '#008373', bgColor: 'rgba(0,131,115,0.08)', searchUrl: (q) => `https://www.bing.com/search?q=${encodeURIComponent(q + ' site:linkedin.com OR site:facebook.com OR site:instagram.com')}`, profileUrl: (q) => `https://www.bing.com/search?q=${encodeURIComponent(q)}` },
  { id: 'pipl', name: 'Pipl People Search', icon: '👤', color: '#8B5CF6', bgColor: 'rgba(139,92,246,0.08)', searchUrl: (q) => `https://pipl.com/search/?q=${encodeURIComponent(q)}`, profileUrl: (q) => `https://pipl.com/search/?q=${encodeURIComponent(q)}` },
];
